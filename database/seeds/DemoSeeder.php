...
class DemoSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('core_settings')->insert([
            ...
            DB::table('core_settings')->insert([
                [
                    'name'  => "g_clickpay_enable",
                    'val'   => "1",
                    'group' => "payment",
                ],
                [
                    'name'  => "g_clickpay_name",
                    'val'   => "Paypal",
                    'group' => "payment",
                ],
                [
                    'name'  => "g_clickpay_test",
                    'val'   => "1",
                    'group' => "payment",
                ],
                [
                    'name'  => "g_clickpay_convert_to",
                    'val'   => "usd",
                    'group' => "payment",
                ],
                [
                    'name'  => "g_clickpay_exchange_rate",
                    'val'   => "1",
                    'group' => "payment",
                ],
                [
                    'name'  => "g_clickpay_test_account",
                    'val'   => "danniejpt-facilitator_api1.gmail.com",
                    'group' => "payment",
                ],
                [
                    'name'  => "g_clickpay_test_client_id",
                    'val'   => "1382325797",
                    'group' => "payment",
                ],
                [
                    'name'  => "g_clickpay_test_client_secret",
                    'val'   => "All7UELmX8cXBdqZcLFf7Nosl74eAsKiRvpoPRbVPpTqxFwEfS0ftnuU",
                    'group' => "payment",
                ]
            ]);
