                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <label>{{__("Custom Tours Enquery")}}</label>
                            <div class="form-controls">
                                <input type="text" name="custom_tours_enquiry_ids" class="form-control" value="{{ $settings['custom_tours_enquiry_ids'] ?? '' }}" placeholder="Enter tour IDs separated by commas">
                            </div>
                        </div>
                    </div>
                </div>
