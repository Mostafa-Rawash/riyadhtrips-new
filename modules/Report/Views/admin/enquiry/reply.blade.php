                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div><strong>{{__("Travel From:")}}</strong> {{$enquiry->travel_from}}</div>

                                <div><strong>{{__("Number of Adults:")}}</strong> {{$enquiry->adult}}</div>

                                <div><strong>{{__("Number of Childrens:")}}</strong> {{$enquiry->children}}</div>
