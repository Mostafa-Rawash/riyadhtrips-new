<div class="panel">
    ...
    <div class="panel-title"><strong>{{__("Basic Availability")}}</strong></div>

    <div class="panel-body">
        <div class="alert alert-info">
            <h5><i class="fa fa-info-circle"></i> {{__("Basic Availability")}}</h5>
            <p>{{__("Use this section for simple tours with fixed schedules. Set overall tour dates and daily open hours.")}}</p>
            <p><strong>{{__("Note:")}}</strong> {{__("If you need specific time slots with individual capacity, use the 'Advanced Time Slots' tab instead.")}}</p>
        </div>
