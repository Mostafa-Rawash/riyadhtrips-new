...
?>
{{-- <h5 class="hed"><strong>Booking Details</strong></h5>
...
<div class="b-table-wrap">
    ...
    <div class="customer-info invice_disc">
        <h4 class="hed"><strong>{!! clean($translation->title) !!}</strong></h4>
        <br>
        <br>
        ...
        <div class="image_bx">
            <?php 
                foreach ($filePaths as $filePath) {
                    ?>
                        <img style="width: 220px;" src="{{ public_path('uploads/' . $filePath) }}" alt="{{ setting_item('site_title') }}">
                    <?php 
                }
            ?>
        </div>
        
        <span>{!! clean($translation->duration) !!}</span>
        <span>{!! clean($translation->content) !!}</span>
                    ...
                    <td valign="top">
                        <ul class="in_disc">
                            @foreach($translation->include as $item)
                                <li> <img style="max-width: 12px; margin-right: 5px;" src="{{public_path( 'uploads/check_icn.png')}}" alt="{{setting_item("site_title")}}"> {{ $item['title'] }}</li>
                            @endforeach
                        </ul>
                    </td>
                    <td valign="top">
                        ...
                        @foreach($translation->exclude as $item)
                            <li> <img style="max-width: 12px; margin-right: 5px;" src="{{public_path( 'uploads/cross_icn.png')}}" alt="{{setting_item("site_title")}}"> {{ $item['title'] }}</li>
                        @endforeach
                        </ul>
                    </td>
                </tr>
