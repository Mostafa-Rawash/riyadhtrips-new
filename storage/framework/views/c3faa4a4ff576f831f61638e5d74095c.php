<div class="panel">
    ...
    <div class="panel-title"><strong><?php echo e(__("Basic Availability")); ?></strong></div>

    <div class="panel-body">
        <div class="alert alert-info">
            <h5><i class="fa fa-info-circle"></i> <?php echo e(__("Basic Availability")); ?></h5>
            <p><?php echo e(__("Use this section for simple tours with fixed schedules. Set overall tour dates and daily open hours.")); ?></p>
            <p><strong><?php echo e(__("Note:")); ?></strong> <?php echo e(__("If you need specific time slots with individual capacity, use the 'Advanced Time Slots' tab instead.")); ?></p>
        </div>
