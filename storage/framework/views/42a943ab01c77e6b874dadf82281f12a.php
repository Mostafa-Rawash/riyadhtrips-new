                        ...
                        <div class="d-flex flex-column overflow-y-auto h-100">
                            ...
                            >
                                ...
                                <?php if($row->id): ?>
                                    ...
                                    <div class="tab-pane" id="tab_time_slots">

                                        <div class="panel">

                                            <div class="panel-title"><strong><?php echo e(__('Time Slots')); ?></strong></div>

                                            <div class="panel-body">

                                                <?php echo $__env->make('Tour::admin/tour/time-slots', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
