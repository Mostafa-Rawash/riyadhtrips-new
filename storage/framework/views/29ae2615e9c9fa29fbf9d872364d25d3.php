...
<?php if(!empty($translation->places)): ?>
<div class="places-visit-section">
    ...
    <div id="placesCarousel" class="carousel slide carousel-custom" data-bs-ride="carousel">
        <div class="carousel-inner">
            <?php $slideIndex = 0; ?>
            <?php $__currentLoopData = $translation->places; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $placeKey => $place): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($loop->first || $loop->iteration % 2 == 1): ?>
                    <div class="carousel-item <?php echo e($slideIndex === 0 ? 'active' : ''); ?>">
                        <div class="row g-3 justify-content-center">
                <?php endif; ?>

                <?php if(is_array($place) && isset($place['title']) && $placeKey !== '__number__'): ?>
                    <div class="col-12 col-md-6">
                        <div class="place-card h-100" data-bs-toggle="modal" data-bs-target="#placeModal<?php echo e($slideIndex); ?>_<?php echo e($loop->iteration); ?>">
                            <?php if(!empty($place['image'])): ?>
                                <div class="place-image-container">
                                    <img src="<?php echo e(FileHelper::url($place['image'])); ?>" alt="<?php echo e($place['title']); ?>" class="place-image img-fluid w-100">
                                    <div class="place-overlay">
                                        <h3 class="place-title"><?php echo e($place['title']); ?></h3>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
    ...
    <?php $modalIndex = 0; ?>
    <?php $__currentLoopData = $translation->places; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modalKey => $place): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if(is_array($place) && isset($place['title']) && $modalKey !== '__place_number__' && !empty($place['image'])): ?>
        <div class="modal fade" id="placeModal<?php echo e(floor($modalIndex / 2)); ?>_<?php echo e($modalIndex + 1); ?>" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog ">
                <div class="modal-content">
                    <div class="modal-body p-0">
                        <div class="modal-image-container">
                            <img src="<?php echo e(FileHelper::url($place['image'])); ?>" alt="<?php echo e($place['title']); ?>" class="modal-image">
                        </div>
                        <div class="place-modal-info">
                            <h3 class="place-modal-title"><?php echo e($place['title']); ?></h3>
                        </div>
...
</style><?php /**PATH /home/riyaoeiu/public_html/themes/BC/Tour/Views/frontend/layouts/details/tour-places-to-visit.blade.php ENDPATH**/ ?>