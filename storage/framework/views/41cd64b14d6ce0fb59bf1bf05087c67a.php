        ...
        <div id="bravo_tour_book_app" v-cloak>
            ...
            <div class="form-book" :class="{'d-none':enquiry_type!='book'}">
                ...
                <div class="form-content">
                    ...
                    <?php if(isset($row->meta->enable_time_slots) && $row->meta->enable_time_slots): ?>
                    <div class="form-section-group form-group" v-if="enable_time_slots && start_date">
                        <h4 class="form-section-title">
                            <i class="fa fa-clock"></i> <?php echo e(__("Select Time")); ?>
                        ...
                        <div v-if="loading_time_slots" class="time-slots-loading text-center py-4">
                            ...
                            <div class="mt-2 text-muted"><?php echo e(__("Loading available times...")); ?></div>
                        </div>
                        ...
                        <div v-else-if="available_time_slots && available_time_slots.length" class="time-slots-container">
                                        ...
                                        <div class="time-slot-info">
                                                ...
                                                <div class="capacity-text">
                                                    <span class="available-spots" 
                                                        ...
                                                        <span v-if="slot.remaining_capacity === 0 || slot.is_sold_out">
                                                            <?php echo e(__("Fully Booked")); ?>

                                                        </span>
                                                        <span v-else-if="!isSlotBookableForCurrentGuests(slot)">
                                                            <?php echo e(__("Need")); ?> {{ getGuestCount() }}, <?php echo e(__("only")); ?> {{ slot.remaining_capacity }} <?php echo e(__("left")); ?>

                                                        </span>
                                                        <span v-else>
                                                            {{ slot.remaining_capacity }} <?php echo e(__("spots left")); ?>
                                            ...
                                            <div class="demand-indicators mt-2">
                                                <span v-if="slot.remaining_capacity === 0 || slot.is_sold_out" class="badge badge-secondary">
                                                    <i class="fa fa-times-circle"></i> <?php echo e(__("Fully Booked")); ?>

                                                </span>
                                                <span v-else-if="!isSlotBookableForCurrentGuests(slot)" class="badge badge-danger">
                                                    <i class="fa fa-exclamation-triangle"></i> <?php echo e(__("Insufficient Capacity")); ?>

                                                </span>
                                                <span v-else-if="slot.is_high_demand" class="badge badge-warning">
                                                    <i class="fa fa-fire"></i> <?php echo e(__("High Demand")); ?>

                                                </span>
                                                <span v-else-if="slot.remaining_capacity <= 3" class="badge badge-warning">
                                                    <i class="fa fa-clock"></i> <?php echo e(__("Almost Full")); ?>

                                                </span>
                                                <span v-else class="badge badge-success">
                                                    <i class="fa fa-check"></i> <?php echo e(__("Available")); ?>
                            ...
                            <div v-if="sold_out_slots && sold_out_slots.length" class="sold-out-toggle mt-3">
                                <button type="button" class="btn btn-link btn-sm" @click="show_sold_out_slots = !show_sold_out_slots">
                                    ...
                                    <span v-if="show_sold_out_slots"><?php echo e(__("Hide Unavailable Times")); ?></span>
                                    <span v-else><?php echo e(__("Show Unavailable Times")); ?> ({{ sold_out_slots.length }})</span>
                                </button>
                            </div>
                            
                            <!-- Sold Out Slots -->
                            <div v-if="show_sold_out_slots && sold_out_slots && sold_out_slots.length" class="sold-out-slots mt-3">
                                <h6 class="text-muted mb-2"><?php echo e(__("Unavailable Times")); ?></h6>
                                <div class="row">
                                    <div v-for="(slot, index) in sold_out_slots" :key="'sold-' + index" class="col-md-6 col-lg-4 mb-2">
                                        <div class="time-slot-card sold-out disabled">
                                            ...
                                            <div class="sold-out-reason text-muted small text-center">
                                                <span v-if="slot.is_sold_out"><?php echo e(__("Fully Booked")); ?></span>
                                                <span v-else-if="slot.is_cutoff_reached"><?php echo e(__("Booking Closed")); ?></span>
                                                <span v-else><?php echo e(__("Unavailable")); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div v-else-if="!loading_time_slots && enable_time_slots" class="no-time-slots text-center py-4">
                            ...
                            <h6 class="text-muted"><?php echo e(__("No available time slots")); ?></h6>
                            <p class="text-muted small mb-0"><?php echo e(__("Please select a different date or contact us for availability.")); ?></p>
                        </div>
                        ...
                        <div v-if="selected_time_slot" class="selected-time-summary mt-3 p-3 bg-light rounded">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <strong><?php echo e(__("Selected Time:")); ?></strong>
                                    <span class="ml-2">
                                ...
                                <button type="button" class="btn btn-sm btn-outline-secondary" @click="clearTimeSlot()">
                                    <i class="fa fa-times"></i> <?php echo e(__("Change")); ?>
...
(function() {
    ...
    function initializeTimeSlots() {
        ...
        const timeSlotProps = {
            enable_time_slots: <?php echo e(isset($row->meta->enable_time_slots) && $row->meta->enable_time_slots ? 'true' : 'false'); ?>, // Enable based on tour configuration
...
<?php /**PATH /home/riyaoeiu/public_html/themes/BC/Tour/Views/frontend/layouts/details/tour-form-book.blade.php ENDPATH**/ ?>