...
<a href="#" onclick="buildWhatsAppLink(event)" target="_blank" rel="noreferrer">
    <span>
        <svg focusable="false" color="inherit" fill="currentcolor" aria-hidden="true" role="presentation" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid meet" width="24px" height="24px" class="icon-whatsapp">
            <g>
        ...
        </svg><?php echo e(__("Contact us via WhatsApp")); ?></span>
</a>
...
function buildWhatsAppLink(e) {
    ...
    let whatsappText = `Hi there! I'm interested in knowing more about <?php echo e($row->title); ?> - Tour id : <?php echo e($row->id); ?>`;
...
</script><?php /**PATH /home/riyaoeiu/public_html/themes/BC/Tour/Views/frontend/layouts/details/tour-package-form-book.blade.php ENDPATH**/ ?>