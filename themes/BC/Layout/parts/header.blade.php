            ...
            <div class="header-right">
                ...
                <ul class="topbar-items">
                    ...
                    <li class="signup-item">
                        ...
                        <a href="#register" data-toggle="modal" data-target="#register" class="signup">{{__('Sign
                            Up')}}</a>
                    ...
                    <li class="login-item dropdown">
                        ...
                        <ul class="dropdown-menu text-left">
                            ...
                            <li class="@if(Auth::user()->hasPermission('dashboard_vendor_access')) menu-hr @endif">
                                ...
                                <a href="{{route('user.profile.index')}}"><i class="icon ion-md-construct"></i> {{__("My
                                    profile")}}</a>
    ...
    <div class="bravo-menu-mobile" style="display:none;">
        ...
        <div class="user-profile">
            ...
            <ul>
                ...
                <li><a href="{{route('vendor.dashboard')}}"><i class="icon ion-md-analytics"></i> {{__("Vendor
                        Dashboard")}}</a></li>
