<tr>
    ...
    <td class="a-hidden">
        ...
        {{-- 🎯 NEW: Display Time Slot Information --}}
        @php 
    ...
    <td width="2%">
        ...
        <a href="{{route('user.booking.downloadInvoice',['code'=>$booking->code])}}" class="btn btn-xs btn-primary btn-info-booking open-new-window mt-1">
